...
class CollidableTest {
    ...
    void findCollision() {
        ...
        assertEquals(Collision.VERTICAL, coll1.findCollision(coll2));
        assertEquals(Collision.HORIZONTAL, coll1.findCollision(coll3));
        assertEquals(Collision.VERTICAL, coll2.findCollision(coll3));
